...
def main(lens, lena, inalphabet, dataset, dataset_type, beta, flag = False):
    lenalphabet = lena
    lenstrings = lens
...
if __name__ == "__main__": 
    ...
    os.chdir(_path)
    beta = 600
    dataset_type = 'uncorrelated'
    number_of_strings = 10
    alphabet = ['A', 'C', 'G', 'T']
    len_alphabet = len(alphabet)
    dataset_name = '10_200_rat'
    flag = False
    lcs, runtime = main(number_of_strings, len_alphabet, alphabet, dataset_name, dataset_type, beta, flag)
    print(lcs, runtime)